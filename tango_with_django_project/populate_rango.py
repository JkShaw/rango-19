...
def populate():
    ...
    # if you want to add more catergories or pages, add them to the
    # dictionaries above
    ...
    # for more information about using items() and how to iterate over a
    # dictionary properly

    # Using the .items returns the key and the value. In this case the key is
    # "Python", "Django" or "Other Frameworks" and the value (cat_data) is the
    # corresponding dictionary in cats.

    for cat, cat_data in cats.items():
        # c = add_cat(cat)
        # Updated the population script to pass through the specific values for
        # views and likes
